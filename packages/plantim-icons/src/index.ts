...
export const PLANTIM_ICONS_VERSION = "2.0.0" as const;
export const PLANTIM_ICONS_REGISTRY_HASH = "7bd691a72d4547801898bf845183e01817bd70bbfc6dee2e535db3e0be4bdc7f" as const;
