...
export const PLANTIM_FLAGS_VERSION = "4.1.0" as const;
export const PLANTIM_FLAGS_HASH = "d1070166f5bf95c2de9e18bd9f3206430864d562ca156a594d34036f87dfc6ee" as const;
...
export const PLANTIM_FLAG_CODES = Object.freeze(["at","ch","de","es","eu","fr","gb","it","nl","pl","pt","tr","unknown","us"] as const);
...
const SIZE_GRADES = Object.freeze({ 16: "micro", 20: "micro", 24: "base", 32: "base", 48: "display", 72: "display" } as const) as Readonly<Record<number, PlantimFlagGrade>>;
const GRADE_STROKES = Object.freeze({ micro: 2.4, base: 2, display: 1.6 } as const) as Readonly<Record<PlantimFlagGrade, number>>;
