...
export const PLANTIM_FLAG_METADATA = Object.freeze({
  "at": {
    "id": "flag.at",
    "code": "at",
    "label": "Austria",
    ...
    "accessibilityLabelKey": "a11y.icons.flag.at",
    "keywords": [
      "at",
      "austria",
      "flag",
  ...
  "de": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.de",
    "keywords": [
      "de",
      "germany",
      "flag",
  ...
  "es": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.es",
    "keywords": [
      "es",
      "spain",
      "españa",
  ...
  "eu": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.eu",
    "keywords": [
      "eu",
      "europe",
      "european union",
  ...
  "fr": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.fr",
    "keywords": [
      "fr",
      "france",
      "flag",
  ...
  "it": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.it",
    "keywords": [
      "it",
      "italy",
      "flag",
  ...
  "nl": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.nl",
    "keywords": [
      "nl",
      "netherlands",
      "flag",
  ...
  "pl": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.pl",
    "keywords": [
      "pl",
      "poland",
      "polska",
  ...
  "us": {
    ...
    "category": "flag",
    "accessibility": "semantic",
    "accessibilityLabelKey": "a11y.icons.flag.us",
    "keywords": [
      "us",
      "usa",
      "united states",
...
}) as Readonly<Record<string, PlantimFlagMetadata>>;
